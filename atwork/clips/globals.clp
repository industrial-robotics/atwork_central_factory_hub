...
(defglobal
  ...
  ?*REDUCED-CHOCOLATE-OBJECTS* = (create$
    [PICKUP_BLACK_WHITE] [DUPLO_CLASSIC]
    [TWIX_CLASSIC] [MARS] 
    [SNICKERS] [KITKAT_WHITE] [RITTERSPORT_JOGHURT]
    [KITKAT_CHUNKY_CLASSIC] [LION_CLASSIC] [LION_MINI] [M_M_CRIPSY]
    [M_M_PEANUT] [BOUNTY] [MILKYWAY] 
  )
